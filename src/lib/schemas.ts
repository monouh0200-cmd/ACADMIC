// src/lib/schemas.ts
// ─────────────────────────────────────────────────────────────────────────────
// Zod Validation Schemas — كل الـ forms في التطبيق
// الاستخدام:
...
export const updateProfileSchema = z.object({
  ...
  whatsapp: whatsappField,
  // الأعمدة الحساسة: role / status / subscription_type محظورة هنا — محمية بـ DB trigger
})
